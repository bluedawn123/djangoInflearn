...
class AccountCreateView(CreateView):
    ...
    form_class = UserCreationForm                          #장고 기본 폼 제공
    success_url = reverse_lazy('accountapp:hello_world2')  #계정 생성 성공 후 어디로 연결할 것인가?..reverser_lazy는 class, reverse는 함수에서 사용
    template_name = 'accountapp/create.html'               #회원가입시 어떤 html을 통해서 볼지 설정. 즉, create.html이 필요하다
